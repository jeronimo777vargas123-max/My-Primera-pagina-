...
Un programa está compuesto por tres partes principales:
1 Entrada: son los datos que recibe el programa 
2 Proceso: operaciones que realiza (cálculos, decisiones, repeticiones).
3 Salidas: son los resultados que muestran.
